          ...
          <main className="flex-1 pt-16">
            <section className="relative flex flex-col items-center justify-center px-4 py-16 md:py-24 lg:py-32">
                <div className="absolute inset-0 z-0 overflow-hidden">
                    ...
                    <div className="h-full w-full bg-cover bg-center" data-alt="Modern office space with blurry background"
                        style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCxyw8uQvI3lauBymbLJDLXEzdFGu71II-LCzo-9V5_32Ct8HbuoQdViEGqVkXWTc16vB-qlh5beI5VEfaq-CfX3LsBh9UszsAYxHYD9zGqlFBbmTu9l6Zask4IxSC_MnsvlSDtuzadKFzFSJKdD5o6FB_HG42nT71TpvUifR4ac9-2edZ7mNBVsf1y3uKXkZTMv4kaQRFWYBOi5CxCFWjscfg159BvcMVpESMCASmlRVNXOUXjMdkTLqxIahGiK-5IR5ywPcID7TE')" }}>
                    </div>
                </div>
